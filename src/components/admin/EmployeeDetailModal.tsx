              ...
              {tasks.length > 0 ? (
                <div className="space-y-3">
                  {tasks.map((task) => (
                    <div
                      key={task._id}
                      className={`border rounded-xl p-4 transition-all ${task.completed
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-start gap-3">
                            <div
                              className={`mt-1 w-5 h-5 rounded flex items-center justify-center ${task.completed
                                  ? "bg-emerald-500"
                                  : "bg-gray-200"
                                }`}
                            >
                            ...
                            <div className="flex-1">
                              <h4
                                className={`font-semibold mb-1 ${task.completed
                              ...
                              <div className="flex flex-wrap gap-2 text-xs">
                                <span
                                  className={`px-2 py-1 rounded-full font-medium ${task.priority === "urgent"
                                ...
                                <span
                                  className={`px-2 py-1 rounded-full font-medium ${task.completed
