...
export default function ChecklistSettings() {
    ...
    const handleCheckChange = (configIndex: number, checkIndex: number, field: 'text' | 'bonus' | 'fine', value: string | number | undefined) => {
        const newConfigs = [...configs];
                                    ...
                                    <div key={checkIndex} className="space-y-2 p-4 border border-neutral-200 rounded-lg bg-neutral-50">
                                        ...
                                        <div className="flex gap-3 items-center">
                                            <div className="flex items-center gap-2 flex-1">
                                                ...
                                                <label className="text-xs text-neutral-600 whitespace-nowrap">Reward Points:</label>
                                                <input
                                                    type="number"
