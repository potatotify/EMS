...
function LoginContent() {
  ...
  const [loginType, setLoginType] = useState<"google" | "client">("google");
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-neutral-200/50 p-8 lg:p-10 relative overflow-hidden">
          ...
          {credentialsError && (
            ...
            >
              <AlertCircle className="w-5 h-5 text-red-600 shrink-0 mt-0.5" />
              <div>
                <p className="text-sm font-semibold text-red-900">{credentialsError}</p>
              </div>
            </motion.div>
          )}
            ...
            <form onSubmit={handleClientSignIn} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all pr-12"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3.5 px-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
              >
                {isLoading ? (
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mt-4">
                <p className="text-xs text-blue-900 text-center leading-relaxed font-medium">
                  👤 Client accounts are created by the admin team. Contact your administrator if you need access.
                </p>
              </div>
            </form>
          )}
